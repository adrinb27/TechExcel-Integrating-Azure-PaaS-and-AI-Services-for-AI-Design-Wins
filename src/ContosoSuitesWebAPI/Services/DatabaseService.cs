...
[KernelFunction]
...

    {
        ...
        using var conn = new SqlConnection(
            connectionString: "Server=tcp:6kse5h4nd6nfe-sqlserver.database.windows.net,1433;Initial Catalog=ContosoSuitesBookings;Persist Security Info=False;User ID=contosoadmin;Password=AbaRbd.270492;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
        );
        conn.Open();
